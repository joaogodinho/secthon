...
public class MultiLevelLogin2 extends LessonAdapter {
	...
	private Element createWorkspaceContent(WebSession s) {
		...
		defendIt(s, user, password, tan, hiddenUser, ec);

		return ec;
	}

	private void defendIt(WebSession s, String user, String password, String tan, String hiddenUser,
			ElementContainer ec) {
	...
	private boolean correctTan(String tan, WebSession s) {
		// if (!getCurrentTan(s).equals("")) { return
		// tan.equals(String.valueOf(currentTan)); }
		if (!getCurrentTan(s).equals("")) {
			return tan.equals(getCurrentTan(s));
		}
		return false;
	}
	...
	public String getInstructions(WebSession s) {
		...
		String instructions = "You are evil Joe. Although you have a valid account, can you access Jane's account?<br/>"
				+ "Your username is <b>Joe</b> and your password is <b>banana</b>. This is your TAN: 15161<br>";
